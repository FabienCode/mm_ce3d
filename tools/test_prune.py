...
def main():
    ...
    backbone_pruned_sa_channels = ((cfg_pruned[0], cfg_pruned[1], cfg_pruned[2]),
                                   (cfg_pruned[3], cfg_pruned[4], cfg_pruned[5]),
                                   (cfg_pruned[6], cfg_pruned[7], cfg_pruned[8]),
                                   (cfg_pruned[9], cfg_pruned[10], cfg_pruned[11]))
    backbone_pruned_fp_channels = ((cfg_pruned[12], cfg_pruned[13]),
                                   (cfg_pruned[14], cfg_pruned[15]))
    ...
    for [m0, m1] in zip(model.modules(), pruned_model.modules()):
    ...
    save_checkpoint(pruned_model, 'pruned_0.05_votenet.pth')
