...
lr_config = dict(policy='step', warmup=None, step=[112, 134])
load_from = "/data/private/hym/project/fcaf3d_midea/log/gp3d/groupfree3d_8x4_scannet-3d-18class-w2x-L12-O512.pth"
# runtime settings
runner = dict(type='RR_EpochBasedRunner', max_epochs=160)
# yapf:disable
log_config = dict(
    interval=30,
    hooks=[
