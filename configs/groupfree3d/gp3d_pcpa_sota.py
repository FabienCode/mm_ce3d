...
model = dict(
    ...
    label_backbone=dict(
        ...
        sa_cfg=dict(
            ...
            use_xyz=True,
            normalize_xyz=True)),
        # init_cfg=dict(type='Pretrained', checkpoint="/data/private/hym/project/fcaf3d_midea/log/checkpoints/gp3d/groupfree3d_8x4_scannet-3d-18class-w2x-L12-O512-pointnetbackbonew2.pth")
    gt_backbone=dict(
        type='PointNet2SASSG',
        in_channels=3,
        num_points=(2048, 1024, 512, 256),
