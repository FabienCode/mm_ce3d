_base_ = [
    '../_base_/datasets/scannet-3d-18class_label.py',
    '../_base_/models/m_gp3d_pcpa.py', '../_base_/schedules/schedule_3x.py',
...
model = dict(
    ...
    label_backbone=dict(
        ...
        init_cfg=dict(type='Pretrained',
                      checkpoint="/data/private/hym/project/fcaf3d_midea/log/checkpoints/gp3d/groupfree3d_8x4_scannet-3d-18class-w2x-L12-O512-pointnetbackbonew2.pth")),
    gt_backbone=dict(
        type='PointNet2SASSG',
        in_channels=3,
        num_points=(2048, 1024, 512, 256),
...
train_pipeline = [
    ...
    dict(
        type='Collect3D',
        keys=[
            'points', 'gt_points', 'gt_bboxes_3d', 'gt_labels_3d', 'pts_semantic_mask',
            'pts_instance_mask'
        ])
]
test_pipeline = [
