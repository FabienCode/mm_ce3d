...
from mmdet3d.ops.pointnet_modules.cof_base_pointnet_sa_module import cof_PointFPModule
...
class cof_PointNet2SASSG(BasePointNet):
    ...
    def __init__(self,
        ...
        for fp_index in range(len(fp_channels)):
            ...
            self.FP_modules.append(cof_PointFPModule(mlp_channels=cur_fp_mlps))
