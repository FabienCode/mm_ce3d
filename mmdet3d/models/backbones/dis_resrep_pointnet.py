...
from mmdet3d.ops.pointnet_modules.dis_pointnet_sa import dis_PointFPModule


@BACKBONES.register_module()
class dis_rr_PointNet2SASSG(BasePointNet):
    ...
    def __init__(self,
        ...
        for fp_index in range(len(fp_channels)):
            if fp_index != len(fp_channels) - 1:
                ...
                self.FP_modules.append(dis_PointFPModule(mlp_channels=cur_fp_mlps))
                if fp_index != len(fp_channels) - 1:
