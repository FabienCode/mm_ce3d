...
# import mmdet3d.utils.resrep_utils as rrutils
#
# try:
...
#
# @HOOKS.register_module()
# class RR_GradientCumulativeOptimizerHook(RR_OptimizerHook):
...
#         super(RR_GradientCumulativeOptimizerHook, self).__init__(**kwargs)
#
...
#
#     @HOOKS.register_module()
#     class RR_Fp16OptimizerHook(RR_OptimizerHook):
...
#             ... )
#             >>> optimizer_hook = RR_Fp16OptimizerHook(loss_scale=loss_scale)
#         """
#
#         def __init__(self,
#                      grad_clip=None,
...
#
#     @HOOKS.register_module()
#     class RR_GradientCumulativeFp16OptimizerHook(RR_GradientCumulativeOptimizerHook,
#                                                  RR_Fp16OptimizerHook):
...
#             super(RR_GradientCumulativeFp16OptimizerHook,
