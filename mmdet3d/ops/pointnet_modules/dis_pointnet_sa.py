...
class dis_BasePointSAModule(nn.Module):
    ...
    def __init__(self,
        ...
        super(dis_BasePointSAModule, self).__init__()
...
class dis_PointSAModuleMSG(dis_BasePointSAModule):
    ...
    def __init__(self,
                 ...
                 normalize_xyz=False,
                 bias='auto'):
        super(dis_PointSAModuleMSG, self).__init__(
            num_point=num_point,
            radii=radii,
...
@SA_MODULES.register_module()
class dis_PointSAModule(dis_PointSAModuleMSG):
    ...
    def __init__(self,
                 ...
                 fps_sample_range_list=[-1],
                 normalize_xyz=False):
        super(dis_PointSAModule, self).__init__(
            mlp_channels=[mlp_channels],
            num_point=num_point,
            radii=[radius],
...
class dis_PointFPModule(BaseModule):
